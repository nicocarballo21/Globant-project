    ...
    <SafeAreaView style={styles.mainContainer}>
      <SafeAreaView style={{...styles.container,  backgroundColor: mode.bg}}>
        <View style={styles.pressableFoto}>
            <Image source={img ? { uri: img } : user_img } style={styles.userImg} />
        </View>
        <View style={styles.UserInfo}>
          <Text style={{ ...styles.keyText, color: mode.text }}>Nombre: {`${name} ${surname}`}</Text>
          <Text style={{ ...styles.keyText, color: mode.text }}>Contacto: {email}</Text>
          <Text style={{ ...styles.keyText, color: mode.text }}>Posición: {position}</Text>
        </View>

        <View style={styles.btnsContainer}>
          <Text style={{...styles.btns_title, color: mode.text }}>Habilidades a aprender</Text>
