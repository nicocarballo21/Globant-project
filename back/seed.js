...
const setupSeed = async () => {
  ...
  const userSeed = [{
    ...
    isMentee: true,
    isAdmin: true,
    skills: shuffleSkill(skillsPromise)
  },
...

{
    ...
    phone: 549112675876,
    personalDescription: "Researching, designing, implementing, and managing software programs. Testing and evaluating new programs.",
    country: "Argentina",
    preferences: shuffleSkill(skillsPromise),
    desLikes: shuffleSkill(skillsPromise).pop(),
